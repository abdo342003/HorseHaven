        ...
        <section className="py-16">
          <Container>
            <div className="rounded-2xl border border-gold/30 bg-panel px-6 py-16 text-center shadow-sm">
              <p className="font-display text-xl font-semibold text-ivory">{t("common.error")}</p>
              <Link
                href="/"
      ...
      <section className="py-12 sm:py-14">
        <Container>
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gold/30 bg-panel p-6 shadow-sm sm:p-8">
              ...
              <h2 className="mt-6 font-display text-lg font-semibold text-ivory">
              ...
              <dl className="mt-5 space-y-2.5 border-t border-gold/30 pt-4 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className={`font-semibold ${order.shipping === 0 ? "text-green" : "text-ivory"}`}>
                ...
                <div className="flex justify-between border-t border-gold/30 pt-3">
                  <dt className="font-semibold text-ivory">{t("confirmation.total")}</dt>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href="/"
                  className="inline-flex flex-1 items-center justify-center rounded-lg border border-royalblue px-6 py-3 text-sm font-semibold text-royalblue transition-colors hover:bg-white/10"
                >
                  {t("confirmation.backHome")}
                </Link>
              </div>
